...
internal class DslViewContainerListAdapterDelegate<I : T, T>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup): AdapterDelegateViewContainerViewHolder<I> =
        AdapterDelegateViewContainerViewHolder<I>(createView(parent)).also {
            initializerBlock(it)
        }
    ...
    override fun onViewRecycled(holder: RecyclerView.ViewHolder) {
        ...
        val vh = (holder as AdapterDelegateViewContainerViewHolder<I>)
...
class AdapterDelegateViewContainerViewHolder<T>(
